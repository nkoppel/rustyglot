...
const RANDOM_CASTLE: [u64; 4] = [
    0x31D71DCE64B2C310,
    0xF165B587DF898190,
    0xA57E6339DD2CF3A0,
    0x1EF6E6DBB1961EC9,
];
const RANDOM_ENPASSANT: [u64; 8] = [
    0x70CC73D90BC26E24,
    0xE21A6B35DF0C3AD7,
    0x003A93D8B2806962,
    0x1C99DED33CB890A1,
...
const RANDOM_TURN: u64 = 0xF8D626AAAF278509;

pub fn book_hash(board: Chess) -> u64 {
    let mut out = 0;
...
pub fn from_book_move(mov: u16) -> Uci {
    ...
    let sq1 = Square::new(i1 as u32);
    let sq2 = Square::new(i2 as u32);

    let promotion = match mov >> 12 {
        0 => None,
...
fn t_hash() {
    ...
    for (fen, hash) in tests {
        let hash2 = book_hash(fen_to_chess(fen));
...
fn t_book_move() {
    ...
    let bookmove = to_book_move(mov.clone());

    println!("{:o}", bookmove);

    assert_eq!(bookmove, 0o5_64_74);
    assert_eq!(from_book_move(bookmove), mov);
}
